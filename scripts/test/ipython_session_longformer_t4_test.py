...
sembeds_2 = sbert.encode(
    ["helder", "margarida"], output_value=None, convert_to_tensor="pt"
)
...
def compare(sentence, sbert, slong):
    ...
    return cos_sim(
        slong_output["sentence_embedding"], sbert_output["sentence_embedding"]
    )
...
sembeds_2 = sbert.encode(
    ["helder", "pretrained_init_configuration"],
    output_value=None,
...
cos_sim(
    ...
    gold_embedding_slong_full["sentence_embedding"],
)
...
def cand_mean_embedding(
    candidate: List[int], doc_input_ids: List[int], doc_token_embeddings
):
...
candidate_embedding_0 = cand_mean_embedding(
    candidate_0,
    doc_embedding_slong["input_ids"].squeeze().tolist(),
    doc_embedding_slong["token_embeddings"],
)
candidate_embedding_1 = cand_mean_embedding(
    candidate_1,
    doc_embedding_slong["input_ids"].squeeze().tolist(),
    doc_embedding_slong["token_embeddings"],
)
candidate_embedding_2 = cand_mean_embedding(
    candidate_2,
    doc_embedding_slong["input_ids"].squeeze().tolist(),
    doc_embedding_slong["token_embeddings"],
)
candidate_embedding_3 = cand_mean_embedding(
    candidate_3,
    doc_embedding_slong["input_ids"].squeeze().tolist(),
    doc_embedding_slong["token_embeddings"],
)
candidate_embedding_4 = cand_mean_embedding(
    candidate_4,
    doc_embedding_slong["input_ids"].squeeze().tolist(),
    doc_embedding_slong["token_embeddings"],
)
candidate_embedding_5 = cand_mean_embedding(
    candidate_5,
    doc_embedding_slong["input_ids"].squeeze().tolist(),
    doc_embedding_slong["token_embeddings"],
)

for embd_candidate in [
    candidate_embedding_0,
    candidate_embedding_1,
    candidate_embedding_2,
    candidate_embedding_3,
    candidate_embedding_4,
    candidate_embedding_5,
]:
